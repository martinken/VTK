                                                 ...
                                                 vtkActor *actor)
{
  ...
  FSSource = replace(FSSource,"//VTK::Normal::Impl",
    ...
    "  vec3 EyeDir = normalize(vertexVC.xyz - EyePos);\n"
    ...
    "      }\n"
    "    else {\n"
    // The normal is the iPoint.xy rotated back into VC (should not need to normalize but precision)
    "      normalVC = normalize(iPoint.x*base1 + iPoint.y*base2);\n"
