...
class vtkCompositePolyDataMapper2VBOEntry
{
public:
  ...
  vtkCompositePolyDataMapper2VBOEntry()
  {
  };
  ~vtkCompositePolyDataMapper2VBOEntry()
  {
                                              ...
                                              unsigned int &flat_index)
{
  ...
  // inherited.
  if (cda->HasBlockVisibility(flat_index))
    {
    this->BlockState.Visibility.push(cda->GetBlockVisibility(flat_index));
    }
  else
    {
    this->BlockState.Visibility.push(this->BlockState.Visibility.top());
    }
